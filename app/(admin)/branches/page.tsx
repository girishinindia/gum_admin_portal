...
import { Plus, GitBranch, Trash2, Edit2, Eye, ArrowUpDown, ArrowUp, ArrowDown, CheckCircle2, XCircle, BarChart3, RotateCcw, AlertTriangle } from 'lucide-react';
...
export default function BranchesPage() {
  ...
  useEffect(() => { setPage(1); }, [searchDebounce, filterCountry, filterState, filterCity, filterType, filterStatus, pageSize, showTrash]);
  useEffect(() => { load(); }, [searchDebounce, page, pageSize, filterCountry, filterState, filterCity, filterType, filterStatus, sortField, sortOrder, showTrash]);
      ...
      {loading ? (
        ...
        <div className={cn('mt-4 bg-white rounded-xl border overflow-hidden shadow-sm', showTrash ? 'border-amber-200' : 'border-slate-200')}>
          <Table>
            ...
            <TBody>
              {items.map(branch => (
                <TR key={branch.id} className={showTrash ? 'bg-amber-50/30' : undefined}>
