            ...
            <div className="flex items-center justify-between bg-slate-50 rounded-lg px-4 py-3 -mt-1">
              ...
              <button
                ...
                onClick={async () => {
                  ...
                  const refreshed = await api.getSubTopicTranslation(editing.id);
          ...
          <div className="border border-indigo-200 rounded-lg overflow-hidden">
            ...
            {aiPanelOpen && (
              <div className="px-4 py-3 bg-white space-y-3">
                ...
                <AiProgressOverlay
                  active={aiLoading}
                  phases={['Analyzing sub-topic content...', 'Generating translation with AI...', 'Processing response...', 'Preparing fields...']}
